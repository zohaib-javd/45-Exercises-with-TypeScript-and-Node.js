...
let names = ["Zohaib", "Javed", "Kashif", "Karim"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
// 12. Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
let message1 = "do you like to eat ice cream?";
...
let places2visit = ["England", "Italy", "America", "Japan", "France"];
...
let country = ["England", "Italy", "America", "Japan", "France"];
console.log("List of countries:");
console.log(country);
// 21. They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
let person = { name: "Zohaib", fname: "male", age: 38 };
console.log(person);
...
let name_1 = "Zohaib";
let name_2 = "Zohaib Javed";
let name_3 = "Muhammad Zohaib Javed";
if (name_1 == name_3) {
...
let favorite_fruits = ["Oranges", "Pineapples", "Strawberries", "Mangoes", "Grapes"];
...
let users = ["Admin", "Eric", "Zohaib", "Kashif", "Karim"];
...
let current_users = ["ADMIN", "ERIC", "ZOHAIB", "KASHIF", "KARIM"];
let new_users = ["ADMIN", "ZOHAIB", "JAVED", "FARHAN", "FAISAL"];
...
let favorite_pizza = ["Pepperoni", "Margherita", "Hawaiian", "Chicago Deep Dish", "Sicilian"];
...
const magician = ["Criss Angel", "David Blaine", "Harry Houdini"];
...
const magicians3 = ["Criss Angel", "David Blaine", "Harry Houdini"];
...
const mycar = createCar("Toyota", "Hilux Revo GRS", { color: "Black", year: "2024" });
console.log(mycar);
